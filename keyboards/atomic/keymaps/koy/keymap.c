...
[_N4] = { /* WIP Neo Ebene 4 hardcoded */
  {KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_PSLS, KC_PAST, KC_NO,   KC_NO,   KC_NO,  KC_TRNS, KC_TRNS },
  {KC_TRNS, KC_PGUP, KC_BSPC, KC_UP,   KC_DEL,  KC_PGDN, KC_NO,   KC_P7,   KC_P8,   KC_P9,   KC_PPLS, N2_MINS, KC_NO,  KC_NO,   KC_MUTE },
  {KC_TRNS, KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_END,  N2_SZ,   KC_P4,   KC_P5,   KC_P6,   KC_COMM, KC_DOT,  KC_ENT, KC_TRNS, KC_VOLU },
  {KC_TRNS, KC_ESC,  KC_TAB,  KC_INS,  KC_PENT, KC_UNDO, N2_CLN,  KC_P1,   KC_P2,   KC_P3,   N2_SCLN, KC_TRNS, KC_NO,  KC_MS_UP,KC_VOLD },
  {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_P0,   KC_MPLY, KC_VOLD, KC_MS_BTN1,KC_MS_BTN2,KC_MS_LEFT,KC_MS_DOWN,KC_MS_RIGHT  },
},
