 ...
 */
 ...
 [QW] = { /* QWERTZ */
  ...
  { KC_LCTL, KC_LGUI, XXXXXXX, KC_LALT, XXXXXXX, XXXXXXX, SPC_FN,  SPC_FN,  XXXXXXX, XXXXXXX, RALT_HOM,KC_END,  KC_LEFT, KC_DOWN, KC_RGHT  },
 },
 ...
 */
 ...
 [FN] = { /* Function Layer */
  ...
  { _______, _______, _______, C(KC_F3),_______, C(KC_F5),_______, C(KC_F7),C(KC_F8),_______, _______, _______, _______, _______, _______  },
  { _______, _______, _______, _______, _______, _______, _______, DE_LBRC, DE_RBRC, DE_LCBR, DE_RCBR, _______, ___T___, ___T___, _______  },
  { MO(SYS), DE_PIPE, _______, _______, DE_LESS, DE_MORE, _______, DE_LPRN, DE_RPRN, _______, _______, _______, _______, _______, _______  },
