...
[_N4] = { /* WIP Neo Ebene 4 hardcoded */
  {KC_TRNS, KC_PGUP, KC_BSPC, KC_UP,   KC_DEL,  KC_PGDN, KC_PSLS, KC_7,   KC_8,    KC_9,    KC_PPLS, N2_MINS},
  {KC_TRNS, KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_END,  KC_PAST, KC_4,   KC_5,    KC_6,    KC_COMM, KC_DOT},
  {KC_TRNS, KC_ESC,  KC_TAB,  KC_INS,  KC_PENT, KC_UNDO, N2_CLN,  KC_1,   KC_2,    KC_3,    N2_SCLN, KC_TRNS},
  {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_0,   KC_SPC,  KC_VOLD, KC_VOLU, KC_MUTE},
},
